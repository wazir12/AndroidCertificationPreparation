...
public class DatabaseDataWorker {
    ...
    private void insertCourse(String courseId, String title) {
        ...
        values.put(NoteDatabase.CourseInfoEntry.COLUMN_COURSE_ID, courseId);
        values.put(NoteDatabase.CourseInfoEntry.COLUMN_COURSE_TITLE, title);

        long newRowId = mDb.insert(NoteDatabase.CourseInfoEntry.TABLE_NAME, null, values);
    }
     ...
     private void insertNote(String noteId, String title, String text) {
        ...
        long newRowId = mDb.insert(NoteDatabase.NoteInfoEntry.TABLE_NAME, null, values);
    }
